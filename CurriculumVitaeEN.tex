...
\begin{document}
    ...
    \begin{center}
        ...
        \end{minipage}
        \hspace{.05cm}{\color{Gray}\rule{.5mm}{2.94cm}}\hspace{.05cm}
    ...
    \noindent
    Software developer with~over five years of~experience, familiar with~many technologies, wishing further development
    and~new challenges.
    ...
    \begin{itemize}[leftmargin=1.5cm] \itemsep.2mm \parskip0mm \parsep0mm
        \item Developing from~scratch a~news application for~iOS in~Swift alone
        \item Simultaneous maintenance of~news application for~iOS written in~Objective-C
    \end{itemize}
